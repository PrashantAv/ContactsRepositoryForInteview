...
$.extend( $.ui, {
	...
	hasScroll: function( el, a ) {
		...
		//If overflow is hidden, the element might have extra content, but the contact wants to hide it
...
$.widget("ui.resizable", $.ui.mouse, {
	...
	_mouseDrag: function(event) {
		...
		// calling the contact callback at the end
...
$.widget("ui.sortable", $.ui.mouse, {
	...
	_clear: function(event, noPropagation) {
		...
		// Note: don't do it if the current item is already removed (by a contact), or it gets reappended (see #4088)
	...
	_create: function() {
		...
		this.menu = $( "<ul></ul>" )
			...
			.mousedown(function( event ) {
				...
				// the contact clicks somewhere outside of the autocomplete
...
$.widget("ui.dialog", {
	...
	_size: function() {
		/* If the contact has resized the dialog, the .ui-dialog and .ui-dialog-content
...
$.extend($.ui.dialog.overlay, {
	...
	resize: function() {
		/* If the dialog is draggable and the contact drags it past the
		 * right edge of the window, the document becomes wider so we
		 * need to stretch the overlay. If the contact then drags the
...
$.widget( "ui.tabs", {
    ...
    _getIndex: function( index ) {
		// meta-function to give contacts option to provide a href string instead of a numerical index.
		...
		this.xhr = $.ajax( $.extend( {}, o.ajaxOptions, {
			...
			error: function( xhr, s, e ) {
				...
				try {
					...
					// called after the contact has selected another tab.
				...
				for (var dRow = 0; dRow < numRows; dRow++) { // create date picker rows
					...
					for (var dow = 0; dow < 7; dow++) { // create date picker days
						...
						tbody += '<td class="' +
							...
							((printDate.getTime() == selectedDate.getTime() && drawMonth == inst.selectedMonth && inst._keyEvent) || // contact pressed key
